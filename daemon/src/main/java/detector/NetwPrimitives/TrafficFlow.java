...
public class TrafficFlow {
    ...
    private volatile Integer totalPayload = 0;
    ...
    * */
    public void addPayload(Packet additional)
    {
        if(totalPayload == 0)
        ...
        processedPackets++;
        totalPayload += additional.getPayloadSize();

        logPacketData(additional);
    }
    ...
    * */
    public void mergeWith(TrafficFlow traffic)
    {
    ...
    * */
    ...
    {
        // More than half of all traffic was generated by single element
        return totalPayload / 2;
    }
